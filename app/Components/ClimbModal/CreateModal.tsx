                        ...
                        <div className="mt-1 flex justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
                            <div className="space-y-1 text-center items-center flex flex-col">
                              {loadingImage 
                                ...
                                : previewImage && climb ? <Image src={previewImage} alt='uploaded image' width={100} height={150} className='mx-auto h-auto w-auto' placeholder="blur" blurDataURL={`${climb.base64}`}></Image>
                                : previewImage? <div className='w-[128px] h-[171px] relative'><Image src={previewImage} alt='uploaded image' fill sizes='40vw' className='h-auto'></Image></div>
                                ...
                                <p className="text-xs text-gray-500">PNG, JPEG, HEIC/HEIF</p>
                            </div>
                        </div>
