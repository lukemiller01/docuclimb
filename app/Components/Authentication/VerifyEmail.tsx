            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    {result? 'Verification Successful' : 'Verification Unsuccessful'}
                  </Dialog.Title>
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                        {result? 'Thank you for verifying your email.' : 'An error occured while verifying your email.'}
                    </p>
                  </div>

                  {!result?
                    <form className="mt-8 space-y-6" onSubmit={(e) => resend(e)}>
                    ...
                    : null}
                    {sent && !result? <p className="text-sm text-gray-500 text-center mt-4">Message sent to {email}</p> : null}
